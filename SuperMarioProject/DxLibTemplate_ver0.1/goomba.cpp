...
Goomba::Goomba(Rect rect) : Object(ObjectManager::makeId())
{
	...
	comR.lock()->setColor(255, 100, 100);
}
...
void Goomba::eventProc(int from, std::string name, std::vector<Event::DataMap> datas)
{
}

void Goomba::activateProc()
{
}

void Goomba::deactivateProc()
{
}

void Goomba::deathProc()
{
}
